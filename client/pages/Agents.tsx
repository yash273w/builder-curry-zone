...
export default function Agents() {
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Our certified luxury real estate professionals are ready to help
              you find your dream property or achieve your investment goals.
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              >
                ...
                <SelectContent>
                  ...
                  <SelectItem value="Investment Properties">
                    Investment Properties
                  </SelectItem>
                  <SelectItem value="Penthouse Suites">
                    Penthouse Suites
                  </SelectItem>
        ...
        <section className="py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Our most experienced and successful agents, recognized for their
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {featuredAgents.map((agent) => (
                <Card
                  key={agent.id}
                  className="overflow-hidden shadow-lg border-primary/20 hover:shadow-xl transition-shadow"
                >
      ...
      {/* All Agents */}
      <section
        className={`py-16 ${featuredAgents.length > 0 ? "bg-muted/30" : ""}`}
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl lg:text-4xl font-bold text-foreground mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {(featuredAgents.length > 0 ? regularAgents : filteredAgents).map(
              (agent) => (
                <Card
                  key={agent.id}
      ...
      <section className="py-20 bg-gradient-to-r from-primary to-primary/80 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
            Our agents are standing by to help you with your luxury real estate
            needs. Contact us today for a personalized consultation.
          </p>
