...
const features = [
  {
    ...
    description:
      "Get accurate property valuations and market insights from our experienced team.",
  },
  {
    icon: Users,
    title: "Dedicated Agent Support",
    description:
      "Work with certified real estate professionals who understand your unique needs.",
  },
  {
    icon: TrendingUp,
    title: "Investment Guidance",
    description:
      "Make informed decisions with our comprehensive investment analysis and forecasting.",
  },
];
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="text-xl lg:text-2xl mb-8 text-gray-200 leading-relaxed">
              Discover exclusive properties, luxury homes, and investment
              opportunities with our award-winning real estate platform.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Search through thousands of properties using our advanced filters
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Explore handpicked luxury properties that offer the finest living
              experiences in prime locations.
            </p>
          </div>
      ...
      <section className="py-20 bg-muted/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              We provide exceptional service and expertise to help you navigate
              the luxury real estate market with confidence.
            </p>
          </div>
          ...
          <div className="bg-card rounded-2xl p-8 lg:p-12 shadow-lg border max-w-4xl mx-auto text-center">
            <div className="flex justify-center mb-6">
              {[...Array(5)].map((_, i) => (
                <Star
                  key={i}
                  className="w-6 h-6 text-real-estate-gold fill-current"
                />
              ))}
            </div>
            <blockquote className="text-xl lg:text-2xl text-foreground mb-8 leading-relaxed">
              "LuxuryRealty helped us find our dream home in record time. Their
              expertise and dedication made the entire process seamless and
      ...
      <section className="py-20 bg-gradient-to-r from-primary to-primary/80 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
            Join thousands of satisfied clients who found their perfect homes
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              ...
              <p className="text-gray-300 mb-6 max-w-md">
                ...
                buy, sell, and invest in the most exclusive properties.
              </p>
